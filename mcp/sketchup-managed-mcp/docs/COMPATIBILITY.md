...
开发基线2019。本 build 在 SU2019 19.0.685 / Ruby2.5.1 上执行了工程实体与审查、恢复、保存、重开编辑测试；详细范围见内嵌 Skill 的 references/verification-0.5.24-r3.md。SU2018、新机器、建筑来源质量和模型对照仍为 not_run。2024/2025记录为planned_not_implemented；更高或未知版本返回adaptation_required。
